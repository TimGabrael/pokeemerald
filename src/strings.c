...
const u8 gText_BirchBoy[] = _("PENIS");
const u8 gText_BirchGirl[] = _("PUSSY");
...
const u8 gText_ThisIsAPokemon[] = _("Show me some of your moves\nand I may give you your own!{PAUSE 96}\p");
...
const u8 gText_BirchInTrouble[] = _("PIMP DADDY is in trouble!\nPick a drug and rescue him!");
const u8 gText_ConfirmStarterChoice[] = _("Do you choose this DRUG?");
